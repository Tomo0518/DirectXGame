...
public:
	...
	static float EaseInOutSine(float t) { return -(cosf((float)M_PI * t) - 1.0f) / 2.0f; }
	...
	static float EaseInOut(float t) { return t < 0.5f ? 2.0f * t * t * t : 1.0f - powf(-2.0f * t + 2.0f, 3) / 2.0f; }
